	...
	while (y < (int)az->map->persoy + 8)
	{
		...
		while (x < (int)az->map->persox + 8)
		{
			...
			az->map->map[y][x] == 0 ? SDL_SetRenderDrawColor(az->main->rend,
					150, 150, 150, 0) : 0;
			az->map->map[y][x] == 1 ? SDL_SetRenderDrawColor(az->main->rend,
					0, 0, 0, 0) : 0;
			az->map->map[y][x] == 2 ? SDL_SetRenderDrawColor(az->main->rend,
					150, 0, 150, 0) : 0;
			az->map->map[y][x] == 3 ? SDL_SetRenderDrawColor(az->main->rend,
					250, 0, 0, 0) : 0;
			az->map->map[y][x] == 4 ? SDL_SetRenderDrawColor(az->main->rend,
					250, 180, 0, 0) : 0;
			az->map->map[y][x] == 5 ? SDL_SetRenderDrawColor(az->main->rend,
					0, 250, 0, 0) : 0;
			az->map->map[y][x] == 6 ? SDL_SetRenderDrawColor(az->main->rend,
					0, 0, 255, 0) : 0;
			az->map->map[y][x] == 7 ? SDL_SetRenderDrawColor(az->main->rend,
					250, 200, 0, 0) : 0;
			az->map->map[y][x] == 8 ? SDL_SetRenderDrawColor(az->main->rend,
					200, 200, 255, 0) : 0;
			az->map->map[y][x] == 9 ? SDL_SetRenderDrawColor(az->main->rend,
					200, 250, 100, 0) : 0;
			az->map->map[y][x] == ENEMY ? SDL_SetRenderDrawColor(az->main->rend,
					100, 0, 0, 0) : 0;
			block.x = x1 * SBLOCK;
			block.y = y1 * SBLOCK;
